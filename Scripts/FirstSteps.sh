...
sudo apt-get install apache2 php php-mysql php-curl php-gd php-soap php-mbstring xrdp rdesktop automake autoconf git build-essential mariadb-server cmake libbz2-dev libace-dev libssl-dev libtool libmariadb-dev -y
